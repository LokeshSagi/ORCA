...
DEV_HUB_USERNAME="ORCA"
DEV_USERNAME="ORCA"
STAGING_USERNAME="ORCA"
PROD_USERNAME="ORCA"

# Your package name from force:package:list
PACKAGE_NAME="ORCATestMod"
...
echo "value coming for devHubSfdxAuthUrl===> $devHubSfdxAuthUrl"
...
echo "value coming for devSfdxAuthUrl===> $devSfdxAuthUrl"
...
echo "value coming for stagingSfdxAuthUrl===> $stagingSfdxAuthUrl"
...
echo "value coming for prodSfdxAuthUrl===> $prodSfdxAuthUrl"
